...
def exibir():
    ...
    artes_jovens = [
        {"nome": "artes_jovens.png", "titulo": "Pack Jovens em Chamas", "qtd": "25 Templates para Instagram", "link": "https://www.canva.com/..."},
    ]
    ...
    st.info("🔄 Novos packs de Congressos, Vigílias e Teens estão a ser processados!")
