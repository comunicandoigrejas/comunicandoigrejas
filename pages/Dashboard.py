...
# PAGINAS disponíveis no sistema com suas respectivas capas associadas
PAGINAS = [
...
def exibir():
    ...
    # Renderiza a capa e a página selecionada abaixo dos botões
    if st.session_state.pagina_atual:
        # Busca os dados da página selecionada atualmente para identificar a capa correspondente
        ...
        if dados_pagina_atual and dados_pagina_atual['capa']:
            caminho_capa = f"assets/{dados_pagina_atual['capa']}"
